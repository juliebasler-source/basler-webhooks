 ...
 *   BILLING_CC - (optional) CC recipient, defaults to rcox@ministryinsights.com
 */
...
export async function sendBillingReport(reportData) {
  ...
  const ccEmail = process.env.BILLING_CC || 'rcox@ministryinsights.com';
  ...
  console.log(`\n📧 SENDING BILLING REPORT TO ${billingEmail} (cc: ${ccEmail})...`);
