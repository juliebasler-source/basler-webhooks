 ...
 * 
 * @version 1.2.0
 * @description QuickBooks Online API integration with OAuth 2.0
...
async function refreshAccessToken() {
  ...
  // Note: In production, you should save the new refresh_token if it changed
  if (data.refresh_token && data.refresh_token !== process.env.QB_REFRESH_TOKEN) {
    console.log('⚠️  NEW REFRESH TOKEN - Update environment variable!');
    console.log(`   New token: ${data.refresh_token}`);
  }
